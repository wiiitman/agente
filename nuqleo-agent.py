...
"""
        ...
        def _do_deploy():
            ...
            # Copiar SOLO los módulos custom SELECCIONADOS (no toda la librería) a los
            # addons del deploy → así --init los instala y el contenedor los ve (ambos
            # montan addons_dir), sin exponer a este cliente módulos de otros que no
            # eligió. Usamos la copia local del repo; solo refrescamos del repo si algún
            # seleccionado no está aún en local (evita un git clone flaky en cada deploy).
