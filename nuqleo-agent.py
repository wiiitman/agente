...
def _install_modules_rpc(container: str, db_name: str, mods_list: list, port: int, version: str, lang: str = 'es_CO', domain: str = '', fiscal: str = '') -> bool:
...
"""
        ...
        def _do_deploy():
            ...
            threading.Thread(
                ...
                args=(container, db_name, mod_list, port, version, lang, mail_domain, fiscal),
                daemon=True
            ).start()
