...
class NuqleoHandler(BaseHTTPRequestHandler):
    ...
    def _handle_deploy(self, body: dict):
        ...
        # Subdominio automático opcional (ej: cliente.nuqleo.app). Si viene, al
        # terminar el deploy le configuramos nginx + SSL para acceso por HTTPS/HTTP2.
...
"""
        ...
        def _do_deploy():
            ...
            if r['ok']:
                ...
                # Subdominio automático con SSL (HTTP/2). El reverse proxy es lo que
                # hace el render fiable pese a la pérdida de paquetes de Contabo.
                if subdomain:
                    ...
                    if res.get('ok'):
                        ...
                        # No bloquea el deploy: Odoo sigue accesible por IP:puerto.
