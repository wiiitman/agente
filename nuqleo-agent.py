...
"""
        ...
        def _do_deploy():
            ...
            # 6. Pre-chown DESPUÉS de copiar todos los addons (uid 101:101 fijo en odoo:16-19).
            #    Hacerlo aquí en vez de post-compose evita el docker restart que costaba 30-60s.
            run(f'chown -R 101:101 {odoo_data} {addons_dir}')
    ...
    def _handle_module_chunk(self, body: dict):
        ...
        os.unlink(tmp_path)
        run(f'chown -R 101:101 {addons_dir}')
        r = run(['docker', 'restart', container])
