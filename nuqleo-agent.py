...
"""
        ...
        def _do_deploy():
            ...
            # que elegirlos en "Tus módulos": el asistente de bienvenida y el de setup
            # inicial, para que la compañía quede configurada desde el primer login.
            ...
            if MODULES_REPO:
                mod_list.extend(['nuqleo_setup', 'company_welcome_wizard'])
